          ...
          {step === 1 && (
            <div className="animate-in fade-in duration-200">
              ...
              <div className="flex flex-col gap-3">
                <div className="w-full relative h-[48px] group rounded-xl overflow-hidden">
                  <button
                    type="button"
                    className="absolute inset-0 w-full px-4 py-3 bg-white border border-white-stroke text-black font-semibold rounded-xl group-hover:bg-white-bg transition-all flex items-center justify-center gap-3 text-sm shadow-sm z-0"
                  >
                  ...
                  <div className="absolute inset-0 z-10 opacity-[0.01] cursor-pointer flex justify-center items-center">
                    <div className="w-full scale-y-[1.2] scale-x-[1.05]">
                      <GoogleLogin
            ...
            <div className="animate-in fade-in duration-200">
              ...
              <form onSubmit={handleStep2Submit} className="space-y-4 font-body" noValidate>
                ...
                <div className="flex flex-col gap-2.5 pt-1">
                  ...
                  <div className="w-full relative h-[46px] group rounded-lg overflow-hidden mt-1">
                    <button
                      type="button"
                      className="absolute inset-0 w-full px-4 py-2.5 bg-white border border-white-stroke text-black font-medium rounded-lg group-hover:bg-white-bg active:scale-[0.99] transition-all flex items-center justify-center gap-2 text-sm shadow-sm z-0"
                    >
                      <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24">
                        <path
