          ...
          {step === 1 && (
            <div className="animate-in fade-in duration-200">
              ...
              <div className="flex flex-col gap-3">
                <div className="w-full flex justify-center h-[48px] items-center relative z-0">
                  <GoogleLogin
            ...
            <div className="animate-in fade-in duration-200">
              ...
              <form onSubmit={handleStep2Submit} className="space-y-4 font-body" noValidate>
                ...
                <div className="flex flex-col gap-2.5 pt-1">
                  ...
                  <div className="w-full flex justify-center h-[46px] items-center relative z-0 mt-1">
                    <GoogleLogin
                      onSuccess={handleGoogleSuccess}
                      onError={handleGoogleError}
                      theme="outline"
